...
import {postSchema, putSchema} from '../../schemmas/role.schema'
...
const roleRoute = (database: RoleWrapper) => {
    ...
    roleRoute.post('/role', schemaValidationMiddleware(postSchema),async (req, res) => {
        // Create a new user
    ...
    roleRoute.put('/role/:id', schemaValidationMiddleware(putSchema),async (req, res) => {
        // Update a user by id
